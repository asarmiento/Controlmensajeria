...
<center><h2><span class="glyphicon glyphicon-list-alt"><br>Estados de Cuenta "Banco de Occidente"</span></h2></center>


<div style="center">
    {{ Form::open(array(
            'action'=>'OccidenteController@getIndex',
            'method'=>'GET',
            'role'=>'form',
            'class'=>'form-inline'
            ))}}
...
<div class="right">
    <li class="dropdown">                  
        ...
        <ul class="dropdown-menu" role="menu">                        
            <li><a>{{ HTML::link('/occidentes/estadopdf', 'Reporte en PDF',array('target'=>'_black')) }}</a></li>    
            <li><a>{{ HTML::link('/occidentes/excel', 'Reporte en Excel') }}</a></li>    
        </ul>               
    </li>               
</div>
...
<div class="right">
    {{ Form::open(array(
            'action'=>'OccidenteController@getImportarestadocuenta',
            'method'=>'GET',
            'role'=>'form',
            'class'=>'form-inline'
            ))}}
    ...
    <table class="table table-striped">
        <thead>
            <tr>
                ...
                <th width="211">{{utf8_encode('Cuenta No.')}}</th>
            ...
            <tr>  
                ...
                <td>
                    <div id="estado_{{$datos->id}}" class="estado">
                        <?php
                        if ($datos->estado_id == 0): echo 'No tiene Estado';
                ...
                <td>
                    <div id="recibido-{{$datos->id}}" class="recibido">
                        <?php
                        if ($datos->comentario == " "): echo "No Tiene";
