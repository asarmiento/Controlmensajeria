...
<meta name="author" content="Sistemas Sistemas">
...
<div class="right">
    <li class="dropdown">                  
        ...
        <ul class="dropdown-menu" role="menu">                        
            <li><a>{{ HTML::link('/occidentes/ckpdf', 'Reporte en PDF',array('target'=>'_black')) }}</a></li>    
            <li><a>{{ HTML::link('/occidentes/ckexcel', 'Reporte en Excel') }}</a></li>    
        </ul>               
    </li>               
</div>
