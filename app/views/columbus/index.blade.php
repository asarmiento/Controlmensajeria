...
<center><h2><span class="glyphicon glyphicon-list-alt"><br>Estados de Cuenta "Columbus"</span></h2></center>

<div style="center">
{{ Form::open(array(
            'action'=>'ColumbusController@getIndex',
            'method'=>'GET',
            'role'=>'form',
            'class'=>'form-inline'
            ))}}
...
<div class="right">
{{ Form::open(array(
            'action'=>'ColumbusController@getImportar',
            'method'=>'GET',
            'role'=>'form',
            'class'=>'form-inline'
            ))}}
...
<div class="right">
    <li class="dropdown">                  
        ...
        <ul class="dropdown-menu" role="menu">                        
            <li><a>{{ HTML::link('/columbus/pdf', 'Reporte en PDF',array('target'=>'_black')) }}</a></li>    
            <li><a>{{ HTML::link('/columbus/excel', 'Reporte en Excel') }}</a></li>    
        </ul>               
    </li>               
</div>
<hr>
...
<table class="table table-striped">
    <thead>
        <tr>
            ...
            <th width="211">{{utf8_encode('No. Factura')}}</th>
            <th width="157">Fecha Factura</th>
            <th width="182">Nombre Cliente</th>
