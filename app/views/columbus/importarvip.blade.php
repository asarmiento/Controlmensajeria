...
<center><h2><span class="glyphicon glyphicon-list-alt"><br>Importar Estados de Cuenta "Columbus"</span></h2></center>
<hr>

<center>{{ Form::open(array(
            'action'=>'ColumbusController@postImportar',
            'method'=>'POST',
            'files' => true,
            'role'=>'form',
...
<center><img src="../../public/img/Muestra-Columbus.jpg"></center>
