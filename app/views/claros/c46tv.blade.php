...
<center><h2><span class="glyphicon glyphicon-list-alt"><br>Ciclo C-46 TV <img src="http://sistema.elcorso.hn/asset/img/logosclientes/logo-claro.png"></span></h2></center>

<div style="center">
{{ Form::open(array(
            'action'=>'ClaroController@postC46tv',
            'method'=>'POST',
            'role'=>'form',
            'class'=>'form-inline'
            ))}}
...
<div class="right">
    <li class="dropdown">                  
        ...
        <ul class="dropdown-menu" role="menu">                        
            <li><a>{{ HTML::link('/claros/pdfc46tv', 'Reporte en PDF',array('target'=>'_black')) }}</a></li>    
            <li><a>{{ HTML::link('/claros/excelc46tv', 'Reporte en Excel') }}</a></li>    
        </ul>               
    </li>               
</div>
<hr>
