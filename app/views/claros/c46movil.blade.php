...
<center><h2><span class="glyphicon glyphicon-list-alt"><br>Ciclo C-46 MÃ³vil <img src="http://sistema.elcorso.hn/asset/img/logosclientes/logo-claro.png"></span></h2></center>

<div style="center">
{{ Form::open(array(
            'action'=>'ClaroController@postC46movil',
            'method'=>'POST',
            'role'=>'form',
            'class'=>'form-inline'
            ))}}
    ...
    {{Form::label('Limpiar Filtro')}}
    {{Form::input('checkbox','limpiar','1',array('class'=>'input-xlarge','id'=>'limpiar'))}}
...
<div class="right">
    <li class="dropdown">                  
        ...
        <ul class="dropdown-menu" role="menu">                        
            <li><a>{{ HTML::link('/claros/pdfc46movil', 'Reporte en PDF',array('target'=>'_black')) }}</a></li>    
            <li><a>{{ HTML::link('/claros/excelc46movil', 'Reporte en Excel') }}</a></li>    
        </ul>               
    </li>               
</div>
<hr> 
...
<table class="table table-striped">
    <thead>
        <tr>
            ...
            <th width="182">{{utf8_encode('Observación')}}</th>
                ...
                <div id="ClaroObservaciondiv_{{$datos->id}}" class="ocultar ClaroObservaciondiv">
                   ...
                   ->orderBy('name','ASC')->get();   ?>
                    <select id="ClaroObservacionSelect_{{$datos->id}}" class="ClaroObservacionSelect">
                        <option value="">Elija una Observacion</option>	
                      <?php 
