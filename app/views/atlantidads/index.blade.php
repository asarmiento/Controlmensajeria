...
<center><h2><span class="glyphicon glyphicon-list-alt"><br>Tarjetas de Crédito "Banco Atlántida"</span></h2></center>
...
{{ Form::open(array(
    ...
    {{Form::input('submit','','Buscar',array('class'=>'btn'))}}
...
<div class="right">
    <li class="dropdown">                  
        ...
        <ul class="dropdown-menu" role="menu">                        
            <li><a>{{ HTML::link('/atlantidads/ckpdf', 'Reporte en PDF',array('target'=>'_black')) }}</a></li>    
            <li><a>{{ HTML::link('/atlantidads/ckexcel', 'Reporte en Excel') }}</a></li>    
        </ul>               
    </li>               
</div>
<hr>
...
<table class="table table-striped">
    <thead>
        <tr>
            ...
            <th width="211">{{utf8_encode('Nombre')}}</th>
            <th width="157">Tipo de tarjeta</th>
            <th width="182"># Tarjeta</th>
            <th width="182">Estado</th>
            <th width="182">Comentario</th>
            <th width="182">Fecha de Recibida:</th>
            <th width="182">Fecha de Entrega</th>
            <th width="182">Mensajero</th>
            <th width="182">Ciudad</th>
            <th>Ciudad Foranea</th>
            <th></th>
        <tr>      
    <thead>
    <tbody>    
            ...
            <td><div id="mensajero_{{$datos->id}}" class="mensajero">
                ...
                <div>
                    <select id="empleadoSelect_{{$datos->id}}" class="ocultar empleadoSelect" >
						<option value="0" >Elija Un Mensajero</option>
                ...
                <!-- Fecha recibido -->
            <td>{{$datos->forranea}}</td>
                <!-- Eliminar -->
             <td><a class="btn btn-danger" href="{{URL::action('AtlantidadController@getDelete',$datos->id)}}"><span class="glyphicon glyphicon-remove-circle"></span></a></td>
         </tr>
        @endforeach
