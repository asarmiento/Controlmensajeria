...
<center><h2><span class="glyphicon glyphicon-list-alt"><br>Revista Hablemos Claro Financiera</span></h2></center>

<div style="center">
{{ Form::open(array(
            'action'=>'HablemosclaroController@getHablemosclarofinanciera',
            'method'=>'GET',
            'role'=>'form',
            'class'=>'form-inline'
            ))}}
...
<div class="right">
    <li class="dropdown">                  
        ...
        <ul class="dropdown-menu" role="menu">                        
            <li><a>{{ HTML::link('/hablemosclaros/pdfrhcf', 'Reporte en PDF',array('target'=>'_black')) }}</a></li>    
            <li><a>{{ HTML::link('/hablemosclaros/excelrhcf', 'Reporte en Excel') }}</a></li>    
        </ul>               
    </li>               
</div>
<hr>
