...
<center><h2><span class="glyphicon glyphicon-list-alt"><br>Estados de Cuenta US$ "Ficohsa"</span></h2></center>

<div style="center">
{{ Form::open(array(
            'action'=>'FicohsaController@getEstadocuentadolar',
            'method'=>'GET',
            'role'=>'form',
            'class'=>'form-inline'
            ))}}
...
<div class="right">
{{ Form::open(array(
            'action'=>'FicohsaController@getImportardolares',
            'method'=>'GET',
            'role'=>'form',
            'class'=>'form-inline'
            ))}}
...
<div class="right">
    <li class="dropdown">                  
        ...
        <ul class="dropdown-menu" role="menu">                        
            <li><a>{{ HTML::link('/ficohsas/pdfd', 'Reporte en PDF',array('target'=>'_black')) }}</a></li>    
            <li><a>{{ HTML::link('/ficohsas/exceld', 'Reporte en Excel') }}</a></li>    
        </ul>               
    </li>               
</div>
