...
<center><h2><span class="glyphicon glyphicon-list-alt"><br>Estados de Cuenta Lps. "Ficohsa"</span></h2></center>
...
<div class="right">
{{ Form::open(array(
            'action'=>'FicohsaController@getImportarlempiras',
            'method'=>'GET',
            'role'=>'form',
            'class'=>'form-inline'
            ))}}
...
<div class="right">
    <li class="dropdown">                  
        ...
        <ul class="dropdown-menu" role="menu">                        
            <li><a>{{ HTML::link('/ficohsas/pdfl', 'Reporte en PDF',array('target'=>'_black')) }}</a></li>    
            <li><a>{{ HTML::link('/ficohsas/excell', 'Reporte en Excel') }}</a></li>    
        </ul>               
    </li>               
</div>
