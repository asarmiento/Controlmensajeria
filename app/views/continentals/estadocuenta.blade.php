...
<center><h2><span class="glyphicon glyphicon-list-alt"><br>Estado de Cuenta Cheques  "Banco de Continental"</span></h2></center>


<div style="center">
{{ Form::open(array(
            'action'=>'ContinentalController@getEstadocuenta',
            'method'=>'GET',
            'role'=>'form',
            'class'=>'form-inline'
            ))}}
...
<div class="right">
{{ Form::open(array(
            'action'=>'ContinentalController@getImportar',
            'method'=>'GET',
            'role'=>'form',
            'class'=>'form-inline'
            ))}}
...
<div class="right">
    <li class="dropdown">                  
        ...
        <ul class="dropdown-menu" role="menu">                        
            <li><a>{{ HTML::link('/continentals/ckpdf', 'Reporte en PDF',array('target'=>'_black')) }}</a></li>    
            <li><a>{{ HTML::link('/continentals/ckexcel', 'Reporte en Excel') }}</a></li>    
        </ul>               
    </li>               
</div>
