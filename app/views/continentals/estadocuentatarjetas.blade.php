...
<center><h2><span class="glyphicon glyphicon-list-alt"><br>Estado de Cuenta Tarjetas  "Banco de Continental"</span></h2></center>


<div style="center">
{{ Form::open(array(
            'action'=>'ContinentalController@getEstadocuentatarjetas',
            'method'=>'GET',
            'role'=>'form',
            'class'=>'form-inline'
            ))}}
